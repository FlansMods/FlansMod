...
public class ModelBiplane extends ModelPlane
{
    public ModelBiplane()
    {
        ...
        bodyWheelModel[0].addBox(-3F, 10F, 5F, 4, 4, 2, 0.0F);		//Left wheel
		bodyWheelModel[1].addBox(-3F, 10F, -7F, 4, 4, 2, 0.0F);		//Right wheel
		bodyWheelModel[2].addBox(-2F, 6F , 5F, 2, 4, 2, 0.0F);		//Left Strut		
		bodyWheelModel[3].addBox(-2F, 6F , -7F, 2, 4, 2, 0.0F);		//Right Strut
