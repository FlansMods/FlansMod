...
public class ModelExcavator extends ModelMechaTool
{
	public ModelExcavator()
	{
		...
		drillModel[5] = new ModelRendererTurbo(this, 13, 0, textureX, textureY);
		drillModel[5].addBox(8, -1.5F, -4F, 5, 1, 1);
		drillModel[6] = new ModelRendererTurbo(this, 13, 0, textureX, textureY);
		drillModel[6].addBox(8, -1.5F, 3F, 5, 1, 1);
		drillModel[7] = new ModelRendererTurbo(this, 13, 0, textureX, textureY);
		drillModel[7].addBox(8, -2F, -3F, 6, 1, 2);
		drillModel[8] = new ModelRendererTurbo(this, 13, 0, textureX, textureY);
