...
public class ModelJeep extends ModelVehicle
{
    public ModelJeep()
    {
        ...
        bodyModel = new NMTModelRenderer[11];	
        ...
        bodyModel[9] = new NMTModelRenderer(this, 90, 28, textureX, textureY);
        bodyModel[10] = new NMTModelRenderer(this, 66, 55, textureX, textureY);
