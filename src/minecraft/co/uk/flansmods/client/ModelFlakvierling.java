...
public class ModelFlakvierling extends ModelAAGun
{
    ...
    {
        baseModel = new NMTModelRenderer[4];
        baseModel[0] = new NMTModelRenderer(this, 0, 0, 128, 64);
        baseModel[1] = new NMTModelRenderer(this, 0, 18, 128, 64);
        baseModel[2] = new NMTModelRenderer(this, 0, 18, 128, 64);
        baseModel[3] = new NMTModelRenderer(this, 0, 18, 128, 64);
		...
		seatModel = new NMTModelRenderer[5];
        seatModel[0] = new NMTModelRenderer(this, 0, 30, 128, 64);	
		seatModel[1] = new NMTModelRenderer(this, 96, 0, 128, 64);	
		seatModel[2] = new NMTModelRenderer(this, 96, 0, 128, 64);	
		seatModel[3] = new NMTModelRenderer(this, 0, 48, 128, 64);	
		seatModel[4] = new NMTModelRenderer(this, 0, 48, 128, 64);	
        ...
        gunModel[0] = new NMTModelRenderer(this, 48, 18, 128, 64);
        gunModel[0].addBox(0F, 0F , 0F, 12, 12, 12, 0.0F);		//Gun Block

		barrelModel = new NMTModelRenderer[4][1];
		barrelModel[0][0] = new NMTModelRenderer(this, 64, 0, 128, 64);
		barrelModel[1][0] = new NMTModelRenderer(this, 64, 0, 128, 64);
		barrelModel[2][0] = new NMTModelRenderer(this, 64, 0, 128, 64);
		barrelModel[3][0] = new NMTModelRenderer(this, 64, 0, 128, 64);	
