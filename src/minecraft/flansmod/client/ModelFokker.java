...
public class ModelFokker extends ModelPlane
{
    public ModelFokker()
    {
		...
		bodyModel[10].addBox(-24F, -9F, -4F, 14, 2, 2, 0.0F);	//MG
		...
		collisionBoxes[1] = new CollisionBox(40, 10, 0, 2);	//Left Wing
		collisionBoxes[2] = new CollisionBox(-40, 10, 0, 1); //Right Wing
    }
}
