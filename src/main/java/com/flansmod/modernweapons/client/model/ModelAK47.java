...
public class ModelAK47 extends ModelGun //Same as Filename
{
	...
	public ModelAK47() //Same as Filename
	{
		...
		gunModel[9] = new ModelRendererTurbo(this, 569, 1, textureX, textureY); // Import Box0
		gunModel[10] = new ModelRendererTurbo(this, 657, 1, textureX, textureY); // Import Box0
		gunModel[11] = new ModelRendererTurbo(this, 745, 1, textureX, textureY); // Import Box0
		gunModel[12] = new ModelRendererTurbo(this, 897, 1, textureX, textureY); // Import Box0
		gunModel[13] = new ModelRendererTurbo(this, 833, 9, textureX, textureY); // Import Box0
		gunModel[14] = new ModelRendererTurbo(this, 305, 17, textureX, textureY); // Import Box0
		gunModel[15] = new ModelRendererTurbo(this, 161, 17, textureX, textureY); // Import Box0
		gunModel[16] = new ModelRendererTurbo(this, 417, 17, textureX, textureY); // Import Box0
		gunModel[17] = new ModelRendererTurbo(this, 513, 17, textureX, textureY); // Import Box0
		gunModel[18] = new ModelRendererTurbo(this, 545, 17, textureX, textureY); // Import Box0
		gunModel[19] = new ModelRendererTurbo(this, 585, 17, textureX, textureY); // Import Box0
		gunModel[20] = new ModelRendererTurbo(this, 625, 17, textureX, textureY); // Import Box0
		...
		gunModel[4].setRotationPoint(-6F, 18F, -1F);
		...
		gunModel[6].addBox(0F, -17F, 0F, 42, 10, 7, 0F); // Import Box0
		gunModel[6].setRotationPoint(-4F, -9F, -3.5F);

		gunModel[7].addBox(0F, -17F, 0F, 35, 8, 6, 0F); // Import Box0
		gunModel[7].setRotationPoint(-47F, -3F, -3F);
		gunModel[7].rotateAngleZ = 0.15707963F;

		gunModel[8].addBox(0F, -17F, 0F, 76, 4, 4, 0F); // Import Box0
		...
		gunModel[12].addBox(0F, -17F, 0F, 48, 5, 5, 0F); // Import Box0
		gunModel[12].setRotationPoint(-3F, -12F, -2.5F);

		gunModel[13].addBox(0F, -17F, 0F, 8, 2, 3, 0F); // Import Box0
		gunModel[13].setRotationPoint(8F, 10F, -1.5F);

		gunModel[14].addBox(0F, -17F, 0F, 50, 12, 4, 0F); // Import Box0
		gunModel[14].setRotationPoint(-46F, 3F, -2F);
		gunModel[14].rotateAngleZ = 0.20943951F;

		gunModel[15].addBox(0F, -17F, 0F, 7, 19, 7, 0F); // Import Box0
		gunModel[15].setRotationPoint(-52F, -4F, -3.5F);

		gunModel[16].addBox(0F, -17F, 0F, 48, 2, 2, 0F); // Import Box0
		gunModel[16].setRotationPoint(36F, -9.5F, -1F);
		...
		gunModel[21].setRotationPoint(76F, -10.5F, -2.5F);


		defaultScopeModel = new ModelRendererTurbo[8];
		defaultScopeModel[0] = new ModelRendererTurbo(this, 833, 1, textureX, textureY); // Import Box0
		defaultScopeModel[1] = new ModelRendererTurbo(this, 873, 1, textureX, textureY); // Import Box0
		...
		defaultScopeModel[5] = new ModelRendererTurbo(this, 193, 17, textureX, textureY); // Import Box0
		defaultScopeModel[6] = new ModelRendererTurbo(this, 1001, 1, textureX, textureY); // Import Box0
		...
		ammoModel[0] = new ModelRendererTurbo(this, 857, 9, textureX, textureY); // Import Box0
		...
		ammoModel[0].setRotationPoint(24.5F, 6F, -2F);
		ammoModel[0].rotateAngleZ = 0.26179939F;

		ammoModel[1].addBox(0F, -17F, 0F, 12, 17, 4, 0F); // Import Box0
		ammoModel[1].setRotationPoint(29.5F, 19F, -2F);
		...
		barrelAttachPoint = new Vector3f(106F /16F, 22F /16F, 0F /16F);

		stockAttachPoint = new Vector3f(29F /16F, 19F /16F, 3F /16F);

		scopeAttachPoint = new Vector3f(0F /16F, 29F /16F, 0F /16F);

		gripAttachPoint = new Vector3f(55 /16F, 15F /16F, 0F /16F);
