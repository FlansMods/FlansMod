        ...
        for (int k2 = 0; k2 < list.size(); ++k2)
        {
            ...
            if (d7 <= 1.0D)
            {
                ...
                if (d8 != 0.0D)
                {
                    ...
                    entity.attackEntityFrom(player == null ? DamageSource.setExplosionSource(this) : new EntityDamageSourceGun(type.shortName, entity, player, type, false), ((int)((d10 * d10 + d10) / 2.0D * 8.0D * explosionSize + 1.0D)));
