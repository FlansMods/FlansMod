...
public class PacketReload extends PacketBase
{
	...
	public PacketReload(EnumHand hand, boolean isForced, int count, int reload)
	{
	...
	public void handleServerSide(EntityPlayerMP playerEntity)
	{
		...
		ItemStack gunStack = isOffHand ? off : main;
    	...
    	if(data != null && gunStack != null && gunStack.getItem() instanceof ItemGun)
    	{
    		...
    		if(((ItemGun)gunStack.getItem()).reload(gunStack, type, playerEntity.worldObj, playerEntity, playerEntity.inventory, hand, hasOffHand, isForced, playerEntity.capabilities.isCreativeMode))
    		{
