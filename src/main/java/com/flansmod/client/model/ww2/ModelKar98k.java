...
// Gun
		...
		gunModel[5] = new ModelRendererTurbo(this,  0,  53, textureX, textureY); // Loader
		...
		gunModel[11] = new ModelRendererTurbo(this,  0,  67, textureX, textureY); // 
		...
		gunModel[5].addBox(0F, 0F, 0F, 7, 1, 2, 0F); // Loader
		...
		gunModel[11].addBox(0F, 0F, 0F, 2, 1, 2, 0F); // Boltaction
		gunModel[11].setRotationPoint(0F, -1F, -1F);
...
// Ammo
		...
		ammoModel[0].addBox(3F, -0.1F, -0.4F, 3, 3, 1, 0F); // Bullet
...
// Pump
		...
		pumpModel[1].setRotationPoint(2F, -0.5F, -3F);
