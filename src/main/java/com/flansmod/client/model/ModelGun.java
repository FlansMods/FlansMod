...
public class ModelGun extends ModelBase 
{
	...
	/** Custom reload Parameters. If Enum.CUSTOM is set, these parameters can build an animation within ModelGun.java */
	public float rotateGunVertical = 0F;
	public float rotateGunHorizontal = 0F;
	public float tiltGun = 0F;
	public Vector3f translateGun = new Vector3f();
	...
	public Vector3f translateClip = new Vector3f();
